## [Unreleased]
- **Folder picker untuk galeri native** -- Settings kini punya tombol "Select folders to scan" yang menampilkan dialog multi-choice untuk memilih folder video mana yang di-scan galeri. (⋮) → "Folders" yang menampilkan dialog multi-choice untuk memilih folder mana yang di-scan. Semua folder video di MediaStore ditemukan otomatis. Pilihan disimpan di SharedPreferences; default tetap scan semua folder. Remote web gallery tidak terpengaruh (selalu scan semua).
