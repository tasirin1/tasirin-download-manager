...
- **VISIONOS adaptive fallback** — Bila HLS gagal (media playlist 404), coba `adaptiveFormats` langsung dari VISIONOS player API. TV client biasanya mengembalikan URL langsung tanpa n-signature. Dipanggil sebelum Piped/Invidious/Cobalt sebagai strategi pertama non-HLS.
